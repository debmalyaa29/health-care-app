...
const AvailabilitySettings = ({ slots }) => {
  ...
  return (
    <Card className="border-emerald-900/20 w-full max-w-2xl mx-auto">
      <CardHeader className="spcae-y-2">
        <CardTitle className="text-xl font-bold text-white flex items-center gap-2"><Clock className='h-5 w-5 mr-2 text-emerald-400' />Availability Settings</CardTitle>
        <CardDescription className="text-sm md:text-base">Set your daily availability for patient appointments</CardDescription>
