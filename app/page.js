        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-muted-foreground text-lg md:text-xl mx-w-md">
                Book appointmen,consult via video and manage your healthcare
                  ...
                  {creditBenefits.map((benefit, index) => {
                    return (
                      <li key={index} className="flex items-start">
                        ...
                        <p
                          className="text-muted-forefround"
          ...
          >
            <CardContent>
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">Join thousand of users who  have simplified their healthcare journey with our platform.Get started today and experiance healthcare the way it should be.</p>
